...
public class PageInfo {
	...
	private int currentPage;		// 현재 요청한 페이지 번호
	private int startPage;			// currentPage의 시작 페이지 번호
	private int endPage;			// currentPage의 마지막 페이지 번호
	private int maxPage;			// 전체 페이지의 마지막 페이지 번호
